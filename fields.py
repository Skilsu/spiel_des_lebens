...
for idx, info in enumerate(fieldinfo):
    if info[2] == "RED":
        FIELDS_NEU.append(RedField(following_fields=info[3],
                                   x=WAYPOINTS[idx][0],
                                   y=WAYPOINTS[idx][1],
        ...
        FIELDS_NEU.append(YellowField(following_fields=info[3],
                                      x=WAYPOINTS[idx][0],
                                      y=WAYPOINTS[idx][1],
                                      rotation=WAYPOINTS[idx][2],
                                      action=info[4],
        ...
        FIELDS_NEU.append(WhiteField(following_fields=info[3],
                                     x=WAYPOINTS[idx][0],
                                     y=WAYPOINTS[idx][1],
                                     rotation=WAYPOINTS[idx][2],
                                     action=info[4],
        ...
        FIELDS_NEU.append(OrangeField(following_fields=info[3],
                                      x=WAYPOINTS[idx][0],
                                      y=WAYPOINTS[idx][1],
                                      rotation=WAYPOINTS[idx][2],
                                      action=info[4],
